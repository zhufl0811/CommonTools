...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.page.setGeometry(QRect(0, 0, 161, 596))
        ...
        self.stackedWidget.setGeometry(QRect(160, 0, 920, 720))
        self.pageVideoResize = QWidget()
        self.pageVideoResize.setObjectName(u"pageVideoResize")
        self.layoutWidget = QWidget(self.pageVideoResize)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(10, 10, 901, 701))
        ...
        self.btnCreateVideoTask = QPushButton(self.layoutWidget)
